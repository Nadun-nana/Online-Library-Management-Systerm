...
<body class="dashboard-body">
    ...
    <div class="page-card" style="max-width: 500px; margin: 40px auto; padding: 30px; background: #fff; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
        <h1><i class="fa-solid fa-rotate-left" style="margin-right:8px;"></i>Return Book</h1>
        ...
        <form action="return_books.php" method="post">
            <div class="form-group" style="margin-bottom: 15px;">
                <label for="borrow_id" style="display: block; margin-bottom: 5px; font-weight: 500;"><i class="fa-solid fa-book" style="margin-right:5px;"></i>Select Borrowed Book:</label>
            ...
            <div class="form-group" style="margin-bottom: 15px;">
                <label for="actual_return_date" style="display: block; margin-bottom: 5px; font-weight: 500;"><i class="fa-solid fa-calendar-day" style="margin-right:5px;"></i>Actual Return Date:</label>
            ...
            <div class="form-group" style="margin-bottom: 20px;">
                <label for="penalty" style="display: block; margin-bottom: 5px; font-weight: 500;"><i class="fa-solid fa-coins" style="margin-right:5px;"></i>Penalty Fee (5 LKR per day):</label>
            ...
            <div class="form-actions" style="display: flex; gap: 15px;">
                <button type="submit" class="btn"><i class="fa-solid fa-rotate-left"></i> Return Book</button>
