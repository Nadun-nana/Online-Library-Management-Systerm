    ...
    <div class="page-card" style="max-width: 500px; margin: 40px auto; padding: 30px; background: #fff; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
        ...
        <form action="borrow_books.php" method="post">
            <div class="form-group" style="margin-bottom: 15px;">
                <label for="book_id" style="display: block; margin-bottom: 5px; font-weight: 500;">Select Book:</label>
            ...
            <div class="form-group" style="margin-bottom: 15px;">
                <label for="borrow_date" style="display: block; margin-bottom: 5px; font-weight: 500;">Date of Borrowing:</label>
